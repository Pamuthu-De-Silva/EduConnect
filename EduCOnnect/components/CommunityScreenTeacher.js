...
import BottemNavBarTeacher from './BottemNavBarTeacher';
...
export default function CommunityScreenTeacher() {
    return (
        <View style={styles.container}>
            ...
            <BottemNavBarTeacher style={styles.bottomNavBar}/>
        </View>
    );
}
...
const styles = StyleSheet.create({
    ...
    title: {
        ...
        color: '#fff',
        marginBottom: 16,
        paddingHorizontal: 16, // Adjust the side padding
    },
    bottomNavBar: {
        position: 'absolute',
        bottom: 0,
